...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.returntmp";
    private static final String ARTIFACT_ID = "happyshare";
    private static final String PACKAGE_NAME = "cn.returntmp.happyshare";
    private static final String TITLE = "知识社区系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.returntmp";
        String artifactIdNew = "happyshare";
        String packageNameNew = "cn.returntmp.happyshare";
        String titleNew = "知识社区系统";
        // 直接执行下面注释的这行代码会报错，因为项目名就含有 happyshare，目录名存在冲突
        // String projectBaseDirNew = projectBaseDir + "-new"; // 一键改名后，“新”项目所在的目录
        String projectBaseDirNew = projectBaseDir.substring(0, projectBaseDir.lastIndexOf(File.separator)) + File.separator + artifactIdNew; // 一键改名后，“新”项目所在的目录
        ...
        System.out.println(projectBaseDirNew + " " + projectBaseDir);
