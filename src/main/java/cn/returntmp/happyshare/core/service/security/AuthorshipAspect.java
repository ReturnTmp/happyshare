package cn.returntmp.happyshare.core.service.security;
...
public class AuthorshipAspect {
    ...
    @Pointcut("@annotation(cn.returntmp.happyshare.core.service.security.annotation.AuthorshipInterceptor)")
